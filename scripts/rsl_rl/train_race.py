...
parser.add_argument("--reward_type", type=str, default="sparse", choices=["sparse", "dense"], help="Reward type: 'sparse' or 'dense'.")
parser.add_argument(
    "--use_wall",
    action="store_true",
    default=False,
    help="Enable wall obstacles in the environment. Changes observation space from 36 to 39.",
)
parser.add_argument(
    "--track",
    type=str,
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # set use_wall and track configuration
    ...
    if args_cli.reward_type == "sparse":
        ...
        roll_pitch_rates_reward_scale = -0.01
        yaw_rate_reward_scale = -0.1
        perception_reward_scale = 0.0
        max_tilt_reward_scale = 0.0
        crash_reward = -1.0
        death_cost = -10.0
    else:  # dense
    ...
    print(f"[INFO] Using {args_cli.reward_type} rewards")
